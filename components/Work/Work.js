...
const Work = () => {
    ...
    const projects = [
...

        {
            ...
            description:
                'An event and ticketing platform developed to simplify the process of creating, managing, and selling tickets online. Organizers can publish events, track attendance, and manage ticket inventory, while users can easily browse events and complete purchases through a modern and responsive interface.',
...

        {
            ...
            description:
                'A complete educational platform designed for schools, teachers, and students to manage academic workflows in one centralized system. The platform includes features such as grade management, course administration, scheduling, announcements, and communication tools between staff and students.',
...

        {
            ...
            description:
                'A modern restaurant website created for The Indian Brasserie to showcase the restaurant’s brand, menu, and atmosphere online. The site includes a visually engaging homepage, an about section introducing the restaurant, and multiple menu pages.',
...

        {
            ...
            technologies: ['Wordpress', 'HTML', 'CSS'],
            description:
                'A restaurant website built for Sigges Husman with a focus on simplicity, accessibility, and easy navigation. The website features a welcoming homepage, a structured menu section, and a contact page.',
...

        {
            ...
            description:
                'A responsive and modern website developed for The Lounge Bar to promote the venue and provide visitors with essential information. The site includes a stylish homepage, food and drink menus, and a contact form connected to a backend system.',
...

        {
            ...
            description:
                'An ongoing creative web project currently under active development. The project focuses on building a modern and visually appealing digital experience using Vue.js and Tailwind CSS.',
...

        {
            ...
            description:
                'A custom website created for The Lobby restaurant and bar, featuring a modern design and responsive user interface. The site includes a homepage, menu pages, and a fully functional contact form integrated with SendGrid.',
...

        {
            ...
            description:
                'A real-time chat application currently under development where users can create accounts, customize profiles with avatars, and communicate instantly with other users.',
...

        {
            ...
            description:
                'A weather application built with React.js that allows users to search for cities or countries and instantly view current weather conditions.',
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-16 px-4"
            id="/Work"
        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="mb-6">
                                        ...
                                        {/* SHORT DESCRIPTION */}
                                        <p className="text-lg text-gray-600 leading-relaxed mb-3 font-k2d">
